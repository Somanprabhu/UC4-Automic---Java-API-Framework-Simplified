...
public class Jobs extends ObjectTemplate{
	...
	public void setJobPriority(UC4Object object, int priority) throws IOException {
	...
	// Modify a property of a Job object
	public void setJobBasics(UC4Object object, UC4HostName Hostname, UC4ObjectName LoginName, UC4ObjectName QueueName) throws IOException {
			ObjectBroker broker = getBrokerInstance();
			Job job = (Job) object;
	...
	public ArrayList<UC4Object> getAllJobsWithFilter(String filter) throws IOException{
		ObjectBroker broker = getBrokerInstance();
		return broker.common.getAllObjectsWithNameFilter(ObjectTypeEnum.JOBS,filter);
	}

	// Created for testing purposes only..
		public String createRandomJobInFolder(Template template, IFolder folder, String JobNamePrefix) throws IOException{
			ObjectBroker broker = getBrokerInstance();
		...
		// Created for testing purposes only..
		public String createRandomJobInFolder(Template template, String command, String host, String login, String queue,  IFolder folder, String JobNamePrefix) throws IOException{
			ObjectBroker broker = getBrokerInstance();
			Random rand = new Random();
			String RandomObjectName = new BigInteger(25, rand).toString(32);
			String ObjectName = JobNamePrefix+RandomObjectName;
		...
		// Created for testing purposes only..
		public String createRandomJobInRandomFolder(Template template) throws IOException{
			ObjectBroker broker = getBrokerInstance();
	...
	// Create an Object
	public void createJob(String JobName,Template template, IFolder folder) throws IOException{
		ObjectBroker broker = getBrokerInstance();
